...
- **28 days of historical data for training**;
- excludes the most recent **7 days** from training;
- scores the following **7-day period**.
...
1. Testing additional telemetry features while avoiding leakage.
2. Comparing several anomaly-detection models.
3. Improving handling of gateways with sparse historical data.
4. Performing stronger time-based model selection.
5. Testing more realistic network-change scenarios.
6. Improving explanations for why individual gateways receive high anomaly scores.
7. Investigating whether gateway groups have different normal operating patterns.
